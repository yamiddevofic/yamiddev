  ...
  return (
    <motion.main
      ...
      className={`relative overflow-hidden z-0
        ...
        ls:p-9 p-8 sm:p-12 lg:p-16 w-full flex flex-col items-center justify-center
        text-gray-900 dark:text-white ${
          isHome
            ? "min-h-[90vh] md:min-h-[85vh]"
            : "xs:min-h-[85vh] min-h-[80vh]"
        } mb-[-0px]`}
    >
      {/* Fondo decorativo animado */}
      <div className="absolute inset-0 opacity-20 dark:opacity-100 bg-[radial-gradient(#2563eb_1px,transparent_1px)] [background-size:32px_32px] animate-gradient-pan" />
      ...
      >
        ...
        <Text isHome={isHome}>
          ...
          <span className="block">
            <span className="font-bold">fluidas</span> y{" "}
            <span className="font-bold">modernas</span>
          </span>
        </Text>

        {isHome && (
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row md:gap-6 lg:gap-8">
