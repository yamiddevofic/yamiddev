...
const ModernAboutMe = () => {
  ...
  return (
    ...
    variants={fadeInUp}
 className="py-14 sm:py-12 w-[95%] md:w-[90%] px-[5%] bg-white/50 dark:bg-slate-950/50 relative rounded-tl-lg rounded-tr-lg rounded-br-lg rounded-bl-lg border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm" id='about-me'>
      ...
      <div className="max-w-8xl mx-auto grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8 md:gap-12 pt-12 md:pt-5">
        ...
        <div className="w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden ring-4 ring-blue-500/30 dark:ring-blue-400/30 mb-4 md:mb-6 ">
            <img 
              src="./dev.jpg" width={715} height={731} loading="lazy" decoding="async" 
          ...
          <div className="flex space-x-4 mb-4 md:mb-6 ">
            <a 
              ...
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] -m-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
            >
 ...
 <div className="w-full bg-white/50 dark:bg-[#2A3233]/50 rounded-xl shadow-lg p-6 md:p-8 border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm mb-4 md:mb-6 shadow-md hover:shadow-lg border border-gray-100 dark:border-gray-700 ">
          ...
          <div>
            <a href="/docs/cv.pdf" className="inline-flex items-center justify-center min-h-[44px] bg-blue-500 hover:bg-blue-600 text-white py-2 mt-4 px-4 rounded-md transition-colors duration-300 w-[100%] ">
              Descargar CV
            </a>
          </div>
        </div>
